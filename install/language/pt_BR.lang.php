...
$mod_strings = array (
  ...
  'ERR_DB_OCI8_VERSION' => 'A sua versão de Oracle não é suportada pelo Sugar. É necessário instalar uma versão compatível com a aplicação Sugar. Por favor consulte a Matriz de Compatibilidade nas Notas de Lançamento para ver que versões de Oracle são suportadas.',
  'LBL_DBCONFIG_MSG1' => 'Por favor forneça o nome da base de dados. Este vai ser o table space padrão a atribuir ao seu usuário.',
  'LBL_Q' => 'Query relativa a Oportunidades',
  'LBL_Q1_DESC' => 'Oportunidades por Tipo',
  'LBL_Q2_DESC' => 'Oportunidades por Conta',
  'LBL_R1' => 'Relatório de Funil de 6 meses de vendas',
  ...
  'LBL_OC_ADMIN' => 'Por favor contate o seu Administrador para resolver este problema.',
  'LBL_OC_SUCCESS' => 'Instalação de Cliente Offline concluída. Por favor clique no botão abaixo para ser transferida para a sua instalação.',
  'LBL_OC_INSTALL_ADMIN_NAME' => 'Nome do usuário do Administrador.',
  'LBL_OC_INSTAL_DIRECTIONS' => 'Por favor insira os detalhes abaixo para instalar e sincronizar devidamente o seu cliente offline.',
  ...
  'ERR_CHECKSYS_FASTCGI_LOGGING' => 'Para uma utilização optimizada do sapi IIS/FastCGI, defina fastcgi.logging para 0 no seu arquivo php.ini.',
  ...
  'ERR_CHECKSYS_NOT_VALID_DIR' => 'Não É Um Diretório Válida',
  ...
  'LBL_CHECKSYS_XML_NOT_AVAILABLE' => 'Funções associadas às XML Parser Libraries que são necessárias à aplicação Sugar não foram encontradas. Talvez seja necessário descomentar a extensão no arquivo php.ini ou recompilar com arquivo binário correcto, dependendo da sua versão de PHP. Por favor consulte o Manual do PHP para mais informações sobre como ativar o Suporte da Base de Dados.',
  'ERR_CHECKSYS_MBSTRING' => 'Funções associadas com a extensão Multibyte Strings PHP (mbstring) que são necessárias à aplicação Sugar não foram encontradas. &lt;br/&gt;&lt;br/&gt;Geralmente, o módulo mbstring não está habilitado por padrão no PHP e deve ser habilitado com --enable-mbstring quando o binário PHP é construído. Por favor consulte o Manual do PHP para mais informações sobre como habilitar o suporte mbstring.',
  ...
  'ERR_CHECKSYS_CUSTOM_NOT_WRITABLE' => 'O diretório personalizado existe mas não é editável. Poderá ser necessário alterar as suas permissões (chmod 766) ou clicar nela com o botão direito e desmarcar a opção somente leitura, dependendo do seu Sistema Operacional. Por favor tome as medidas necessárias para tornar o arquivo editável.',
  'ERR_CHECKSYS_FILES_NOT_WRITABLE' => 'Os arquivos ou diretórios abaixo listados não são editáveis ou estão em falta e não podem ser criados. Dependendo do seu Sistema Operacional, a correção pode exigir que altere as permissões nos arquivos ou no diretório de origem (chmod 766), ou que clique com o botão direito no diretório de origem e desmarque a opção \'somente leitura\' e aplicá-la a todas as subpastas.',
  ...
  'LBL_UPLOAD_MAX_FILESIZE_TITLE' => 'Tamanho do arquivo de Upload',
  ...
  'ERROR_LICENSE_EXPIRED2' => 'dia(s) atrás. Por favor vá até <a href=\'index.php?action=LicenseSettings&module=Administration\'>\'"Gerenciamento de Licenças"</a> no painel de Administração para inserir a sua nova chave de licença. Se não inserir uma nova chave de licença nos 30 dias seguintes à expiração da chave anterior, não poderá mais acessar a esta aplicação.',
  ...
  'ERROR_VALIDATION_EXPIRED2' => 'dia(s) atrás. Por favor vá até <a href=\'index.php?action=LicenseSettings&module=Administration\'>\'"Gerenciamento de Licenças"</a> no painel de Administração para inserir a sua nova chave de licença. Se não inserir uma nova chave de validação nos 30 dias seguintes à expiração da chave anterior, não poderá mais acessar a esta aplicação.',
  'ERROR_VERSION_INCOMPATIBLE' => 'O arquivo carregado não é compatível com esta versão do Sugar:',
  'LBL_BACK' => 'Voltar',
  'LBL_CANCEL' => 'Cancelar',
  'LBL_ACCEPT' => 'Eu Aceito',
  'LBL_CHECKSYS_1' => 'Para que a sua instalação SugarCRM funcione corretamente, por favor assegure-se que todos os itens de verificação do sistema abaixo listados estão em verde. Se algum deles estiver em vermelho, por favor tome as medidas necessárias para o corrigir.<BR><BR> Para mais ajuda sobre estas verificações de sistema, por favor visite a <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>.',
  ...
  'LBL_CHECKSYS_MODULE' => 'Arquivos e Subdiretórios de Módulos Editáveis',
  ...
  'LBL_MSSQL_FTS_INSTALLED_ERR2' => 'Pode continuar a instalação, mas não será capaz de usar a Pesquisa de Texto Completo a menos que reinstale o SQL Server com essa funcionalidade activada. Por favor consulte o manual de instalação SQL Server para mais informações, ou contate o seu Administrador.',
  ...
  'LBL_DISABLED_DESCRIPTION' => 'O instalador já foi executado uma vez. Como medida de segurança, foi desactivada uma segunda execução. Se tem certeza absoluta que deseja executá-lo novamente, por favor vá ao seu arquivo config.php e localize (ou adicione) uma variável chamada \'installer_locked\' e defina-a como \'falso\'. A linha deve ficar assim:',
  ...
  'LBL_INSTALL_TYPE_MSG2' => 'Requer o mínimo de informação para a instalação. Recomendado para novos usuárioes.',
  'LBL_INSTALL_TYPE_MSG3' => 'Fornece opções adicionais para definir durante a instalação. A maioria destas opções também está disponível após a instalação nos ecrãs de administração. Recomendado para usuárioes avançados.',
  ...
  'LBL_LICENSE_NUM_USERS' => 'Número de usuárioes',
  ...
  'LBL_PERFORM_CREATE_DB_USER' => 'A criar o nome do usuário e senha da Base de Dados...',
  'LBL_PERFORM_CREATE_DEFAULT' => 'A criar dados padrão do Sugar',
  'LBL_PERFORM_CREATE_LOCALHOST' => 'A criar o nome do usuário e senha da Base de Dados para o servidor local...',
  ...
  'LBL_PERFORM_DEFAULT_USERS' => 'A criar usuárioes padrão',
  ...
  'LBL_REG_CONF_3' => 'Obrigado por se registrar. Clique no botão Concluir para acessar ao SugarCRM. É necessário fazer o login pela primeira vez utilizando o nome "admin" e a senha que inseriu no passo 2.',
  ...
  'LBL_SITECFG_CUSTOM_LOG_DIRECTIONS' => 'Se selecionado, deve especificar uma diretório log para substituir a diretório padrão do log Sugar. Independentemente do local do arquivo, o seu acesso por web browser será restrito através de um redireccionamento .htaccess.',
  ...
  'LBL_SITECFG_CUSTOM_SESSION' => 'Utilizar um diretório de Sessão Personalizada para o Sugar',
  ...
  'LBL_SITECFG_ANONSTATS_DIRECTIONS' => 'Se selecionado, o Sugar enviará estatísticas <b>anônimas</b> sobre a sua instalação para a SugarCRM Inc. cada vez que o seu sistema procurar por novas versões. Esta informação irá ajudar-nos a entender melhor como a aplicação é utilizada e guia de melhorias ao produto.',
  ...
  'LBL_SITECFG_SYS_NAME_MSG' => 'Insira um nome para o seu sistema. Este nome será exibido na barra do título do browser quando os usuárioes visitarem a aplicação Sugar.',
  ...
  'LBL_WELCOME_2' => 'Para documentação de instalação, por favor visite a <a href="http://www.sugarcrm.com/crm/installation" target="_blank">Sugar Wiki</a>. <BR><BR> Para contatar um engenheiro de suporte do SugarCRM para ajuda na instalação, por favor acesse <a target="_blank" href="http://support.sugarcrm.com">Portal de Suporte SugarCRM</a> e submeta uma ocorrência de suporte.',
  'LBL_TITLE_ARE_YOU_READY' => 'Está pronto para instalar?',
  ...
  'LBL_SESSION_ERR_DESCRIPTION' => 'O SugarCRM baseia-se em sessões PHP para armazenar informações importantes enquanto estiver conectado a este servidor web. A sua instalação PHP não tem as informações de sessão corretamente configuradas. <br><br>Um erro de configuração comum é o de que a directiva <b>\'session.save_path\'</b> não está a apontar para um diretório válida. <br> <br> Por favor corrija a sua <a target=_new href=\'http://us2.php.net/manual/en/ref.session.php\'>configuração PHP</a> no arquivo php.ini localizado aqui em baixo.',
