...
$mod_strings = array (
  ...
  'LBL_EMAIL_DEFAULT_DELETE_ATTACHMENTS' => 'Elimine Anotações relacionadas e arquivos em anexo com E-mails eliminados',
  ...
  'LBL_CAMP_MESSAGE_COPY_DESC' => 'Pretende armazenar cópias completas de CADA mensagem de e-mail enviada durante todas as campanhas? Recomendamos-lhe Não por padrão. Escolhendo Não irá armazenar apenas os modelos que são enviados e as variáveis necessárias para recriar a mensagem individual.',
  ...
  'LBL_NOTIFY_SEND_BY_DEFAULT' => 'Enviar notificações por padrão a novos usuários?',
  ...
  'LBL_SAVE_OUTBOUND_RAW' => 'Salvar E-mails de Saída Não Tratados',
  ...
  'LBL_SECURITY_OUTLOOK_DEFAULTS' => 'Selecionar precauções de segurança mínimas por padrão do Outlook (erros do lado da exibição correcta).',
